            ...
            <div className="col-xl-6 py-4 ">
              <div className={styles.footer_image}>
                ...
                <div>
                  ...
                  <h2 className="text  "> <a href="tel:9973595208" className="text-reset text-decoration-none">9973595208</a></h2>
                </div>
              </div>
            </div>
            <div className="col-xl-6 py-4 ">
              ...
              <div className={styles.footer_maindiv}>
                <Slide right>
                  <div>
                    <a href="https://github.com/sanojkumaryadav" target="_blank">
                      <svg
                  ...
                  <div>
                    <a href="https://www.linkedin.com/in/sanojcoder/" target="_blank">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="46"
                        height="46"
                  ...
                  {/* <div>
                    <a href="mailto:sanojsanoj638@gmail.com?subject=subject&cc=sanojsanoj638@gmail.com">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="46"
                        height="46"
